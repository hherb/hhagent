...
**Last updated:** 2026-09-02 · **DGX RUNNING `121f22a2` — the whole guard arc is DEPLOYED**
(see [The DGX redeploy](#the-dgx-redeploy--done-2026-09-02-the-guard-arc-is-live)). ·
**`main` HEAD:** `121f22a2` —
[#645](https://github.com/hherb/kastellan/pull/645) squash-merged (#641, #642, #643 — the three
follow-ups #640's own review filed — plus a movement-only `LlmEndpoint` split), on top of
...
**FIRST: the guard arc's remaining work is one item and it is the one that matters:**
